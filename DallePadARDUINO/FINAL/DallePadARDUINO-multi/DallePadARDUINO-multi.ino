...
const int analogInputs = 0; // define how many pots are active up to number of available analog inputs
const int digitalInputs = 5;
...
int cc2 = 53;
int cc3 = 54;
int lastRead[digitalInputs] = {1, 1, 1, 1, 1};
int newRead[digitalInputs] = {0, 0, 0, 0, 0};
 ...
 if (buttonState[i] == LOW)
   {
      ...
      MIDImessage(176, 1, i); // usbMIDI.sendControlChange(i, ccValue[i], 3);
      lastRead[i] = 1;
      }
      // set raw reading to lagged array for next comparison
    }
