...
\autor{
Leonardo Winter Pereira, Lucas Zimmermann Cordeiro} % Autor do trabalho
\cita{WINTER PEREIRA, Leonardo; ZIMMERMANN CORDEIRO, Lucas} % sobrenome (maiúsculas), Nome do autor do trabalho
...
\orientador{NOME DO PROFESSOR ORIENTADOR} % nome do orientador do trabalho
