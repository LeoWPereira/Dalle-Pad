...
\usepackage{color} % para poder usar cores diferentes no documento
\usepackage{float} % para controlar a posição de figuras no documento
\usepackage{chngcntr} % para utilizar enumeração não-contínua de figuras
\usepackage{caption, subcaption} % para figuras / subfiguras

\counterwithin{figure}{chapter} % a enumeração de figuras será separado por capítulos
\counterwithin{table}{chapter} % a enumeração de tabelas será separado por capítulos
