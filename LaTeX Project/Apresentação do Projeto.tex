...
% Link for download: http://www2.informatik.uni-freiburg.de/~frank/ENG/latex-course/latex-course-3/latex-course-3_en.html
...
\usepackage[utf8]{inputenc} % pacote para acentuação diret
\usepackage{lmodern}
